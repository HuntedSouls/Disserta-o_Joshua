...
% Inter concepts
% Emotions
%\path[-latex, dashed, black, very thick] (emo3.west) edge  coordinate[midway](c_to_m) (emo6.east);
%\draw [->, line width=0.5mm, dotted] (emo3.west) -- (emo3.west.x-1,emo3.west.y) -- (emo6.west.x-1,emo6.west.y) (emo6.west);
