...
\begin{document}
	...
	\title{Developing an ontology of board games based on the MDA framework}
	\foreigntitle{Desenvolvendo uma ontologia de jogos de tabuleiro fundamentada no framework MDA}
